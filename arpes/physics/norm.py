...
def _remove_grid_artifact_fft2_mask(
    data_2d: np.ndarray,
    *,
    ...
    Inspiré de `manual_grid_remove.ipf` : les pics masqués de la magnitude FFT
    sont remplacés par une valeur moyenne, tandis que la phase est conservée.
    """
