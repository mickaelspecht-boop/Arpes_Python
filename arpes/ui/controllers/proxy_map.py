...
PROXY_MAP = {
    ...
    "_inject_fs_lattice_into_raw": "_fs_ctrl",
    "_update_fs_kz_label": "_fs_ctrl",
    "_lattice_summary": "_fs_ctrl",
    "_restore_fs_crystal_settings_from_entry": "_fs_ctrl",
    "_on_propagate_distortion_fs_toggled": "_fs_ctrl",
    "_apply_distortion_to_fs_volume_if_enabled": "_fs_ctrl",
